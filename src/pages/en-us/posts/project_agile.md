...
## <i class="fa-solid fa-ruler-combined"></i> The twelve ~~Commandments~~ Principles of Agile

While `Agile` is indeed a `Framework` of practices, there are `twelve principles` which should always be upheld:

### <i class="fa-solid fa-1"></i> Get Your Priorities Straight
...
### <i class="fa-solid fa-2"></i> [The Wind of Change](https://open.spotify.com/track/3ovjw5HZZv43SxTwApooCM?si=44f78920c4394618)
...
### <i class="fa-solid fa-3"></i> Keep on Deliverin'
...
### <i class="fa-solid fa-4"></i> One Mind, Many Hearts
...
### <i class="fa-solid fa-5"></i> The Team Makes The Dream Come True
...
### <i class="fa-solid fa-6"></i> Avoid E-Mails That Cloud Be a Conversation
...
### <i class="fa-solid fa-7"></i> How Far Are We?
...
### <i class="fa-solid fa-8"></i> Keeping Up the Pace
...
### <i class="fa-solid fa-9"></i> Attention to the Details

> Continuous attention to technical excellence and good design enhances agility.

As we `embrace changes`, we must take some time to `review previous work`. We must take good care of the `design` and `techniques` being used by the team as they may need some teaks.

Tweaking the `tools`, `design` and `techniques` over time will allow the team to `perform better`.

### <i class="fa-solid fa-1"></i><i class="fa-solid fa-0"></i> Give it a KISS
...
### <i class="fa-solid fa-1"></i><i class="fa-solid fa-1"></i> Self Improvement Is Real
...
### <i class="fa-solid fa-1"></i><i class="fa-solid fa-2"></i> Hindsight is 20/20
